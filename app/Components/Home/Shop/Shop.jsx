              ...
              <div className={styles.OneTop}>
                ...
                <div className={styles.OneTopBottom}>
                  <p>
                    ...
                    clarity. Designed for consistent performance across espresso
                    and filter brewing.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.TwoTop}>
                ...
                <div className={styles.TwoTopBottom}>
                  <p>
                    ...
                    brewing. Enjoy a balanced, clean cup anywhere, just add hot
                    water and brew with ease.
                  </p>
                </div>
              </div>
            ...
            <div className={styles.Three}>
              <div className={styles.ThreeTop}>
                ...
                <div className={styles.ThreeTopBottom}>
                  <p>
                    Precision-packed capsules crafted for consistent extraction
                    and smooth flavor. Perfect for quick, effortless coffee
